...
import csv
import sys
#Dir of files to process T3 downloaded from Sherlock
dir = sys.argv[1]
dircsvT3 = dir + '\T3.csv'
#Output file AudioLight.arff
dirarff = dir + '\AudioLight.arff'

with open(dircsvT3) as infile:
